...
const TRANSFER_SOL_TO_ETH_BTN = document.getElementById("transfer_sol_to_eth_btn");
...
const TRANSFER_ETH_TO_SOL_BTN = document.getElementById("transfer_eth_to_sol_btn");
